...
const Footer = () => {
  return (
    <footer className="relative mt-20 py-12 ocean-gradient">
      <div className="container mx-auto px-6">
          ...
          <div className="flex items-center space-x-4 mb-8 lg:mb-0">
            <div className="relative">
              <img 
                src={compass} 
                alt="Compass" 
                className="w-12 h-12 compass-rotate opacity-80" 
              />
            </div>
            <div>
              <h3 className="text-xl font-bold text-foreground">Hidden RWA Shipping</h3>
              <p className="text-muted-foreground">Private Logistics, Public Trust</p>
            </div>
          </div>

          {/* Navigation links */}
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8 mb-8 lg:mb-0">
            <a href="#contracts" className="text-muted-foreground hover:text-primary transition-colors">
              Smart Contracts
            </a>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center">
          <p className="text-sm text-muted-foreground">
            © 2024 Hidden RWA Shipping. All rights reserved. | 
            <span className="ml-2">Securing global trade through encrypted contracts</span>
          </p>
        </div>
      </div>
    </footer>
